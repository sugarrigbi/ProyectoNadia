from App.Utilities.Extension import db, BaseModel
from datetime import datetime
class Estado_Caso(BaseModel):
...
class Caso_Auditoria(BaseModel):
...
class Usuario_Auditoria(BaseModel):
...
class Estado_Usuario(BaseModel):
