...
from App.Utilities.Get import Get_Books, Get_Categories, Get_Publisher, Get_Authors, Get_Books_Authors
...
def Books_Read_By():
    ...
    if Field == "Authors":
        return Get_Books_Authors.Books_Authors_Read_By(Value)
...
@Catalog_Bp.route("/Books/Delete/Selected", methods=["DELETE"])
def Bp_Books_Delete_Selected():
    Book_List = request.get_json()
    return Get_Books.Books_Delete_Selected(Book_List)
