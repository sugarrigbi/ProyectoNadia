...
INSERT INTO `tbl_barrio` VALUES ('000BAR','No','000LOC'),('001BAR','Santa Lucia','001LOC'),('002BAR','asdasdad','002LOC'),('003BAR','Prueba','003LOC');
...
CREATE TABLE `tbl_caso` (
  ...
  `Caso_Asociado` varchar(45) COLLATE utf8mb4_general_ci NOT NULL,
  ...
  `fk_prioridad` varchar(10) COLLATE utf8mb4_general_ci NOT NULL,
  `fk_departamento` varchar(10) COLLATE utf8mb4_general_ci NOT NULL,
  `fk_ciudad` varchar(10) COLLATE utf8mb4_general_ci NOT NULL,
  `fk_localidad` varchar(10) COLLATE utf8mb4_general_ci NOT NULL,
  `fk_barrio` varchar(10) COLLATE utf8mb4_general_ci NOT NULL,
  ...
  KEY `fk_barrio` (`fk_barrio`),
  KEY `fk_localidad` (`fk_localidad`),
  CONSTRAINT `fk_barrio` FOREIGN KEY (`fk_barrio`) REFERENCES `tbl_barrio` (`Id_barrio`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `fk_ciudad` FOREIGN KEY (`fk_ciudad`) REFERENCES `tbl_ciudad` (`Id_ciudad`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `fk_departamento` FOREIGN KEY (`fk_departamento`) REFERENCES `tbl_departamento` (`Id_dep`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `fk_localidad` FOREIGN KEY (`fk_localidad`) REFERENCES `tbl_localidad` (`Id_local`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `fk_prioridad` FOREIGN KEY (`fk_prioridad`) REFERENCES `tbl_prioridad` (`Id_prioridad`) ON DELETE RESTRICT ON UPDATE CASCADE,
...
INSERT INTO `tbl_caso` VALUES ('001CAD','2025-11-06','aaaaaaaaaaaaaaa',2,'Dg 49 sur','No','000USU','Despl','Caso','Caso_01','Nivel1','001DEP','001CIU','001LOC','001BAR'),('002CAD','2025-11-17','asdddddddddddddddddddddddddddddddd',23,'asdasdas','No','002USU','Despl','Caso','Caso_01','Nivel1','001DEP','001CIU','001LOC','002BAR'),('003CAD','2025-12-01','asdasdaasdasdaasdasdaasdasda',3,'Prueba_Admin','No','007USU','Despl','Caso','Caso_01','Nivel1','001DEP','001CIU','001LOC','001BAR');
...
INSERT INTO `tbl_ciudad` VALUES ('000CIU','No','000DEP'),('001CIU','Bogota','001DEP'),('002CIU','PruebaAdmin','003DEP'),('003CIU','Prueba','004DEP'),('004CIU','EXITOSA','005DEP');
...
INSERT INTO `tbl_departamento` VALUES ('000DEP ','No'),('001DEP','Cundinamarca'),('002DEP','asdasdasd'),('003DEP','PruebaAdmin'),('004DEP','Prueba'),('005DEP','EXITOSA');
...
CREATE TABLE `tbl_dispositivos` (
  `Id_dispositivo` varchar(8) NOT NULL,
  ...
  KEY `Fk_usuario` (`Fk_usuario`),
  CONSTRAINT `Fk_usuario` FOREIGN KEY (`Fk_usuario`) REFERENCES `tbl_usuario` (`Id_usuario`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `tbl_dispositivos` VALUES ('001DEV','127.0.0.1','15db4dfabff880fca7a111a4d1f7486fd24214d3543ceb4cd295d6f426eb6112','Chrome 143.0.0','Windows 10','Computador','2025-11-11 14:24:52','2026-01-05 13:37:45',1,'000USU'),('002DEV','58.122.37.144','e7b68a2930c4a212951b80292bb23cbc07be676cd08e9d9d1b1031a5cefbc55b','Chrome 119.0 Mobile','Windows 10','Computador','2025-12-11 14:27:03','2024-08-07 05:26:58',1,'000USU'),('003DEV','142.73.199.28','e7b68a2930c4a212951b80292bb23cbc07be676cd08e9d9d1b1031a5cefbc55b','Firefox 118.2 ESR','Windows 11','Desconocido','2025-12-11 14:27:03','2023-12-29 23:18:44',1,'000USU'),('004DEV','213.98.44.7','e7b68a2930c4a212951b80292bb23cbc07be676cd08e9d9d1b1031a5cefbc55b','Safari 17.4 iOS','Android 13','Móvil','2025-12-11 14:27:03','2024-03-04 11:41:26',1,'000USU'),('005DEV','64.17.250.133','e7b68a2930c4a212951b80292bb23cbc07be676cd08e9d9d1b1031a5cefbc55b','Edge 121.0','Android 14','Tablet','2025-12-11 14:27:03','2024-06-21 16:12:03',1,'000USU'),('006DEV','185.203.91.12','e7b68a2930c4a212951b80292bb23cbc07be676cd08e9d9d1b1031a5cefbc55b','Opera GX 102.0','iOS 17','Desconocido','2025-12-11 14:27:03','2024-10-15 07:55:49',1,'000USU'),('007DEV','102.56.14.77','e7b68a2930c4a212951b80292bb23cbc07be676cd08e9d9d1b1031a5cefbc55b','Brave 1.63 Chromium','Linux x86_64','Tablet','2025-12-11 14:27:03','2024-12-28 18:33:07',1,'000USU'),('008DEV','37.124.89.210','e7b68a2930c4a212951b80292bb23cbc07be676cd08e9d9d1b1031a5cefbc55b','Vivaldi 6.4','Ubuntu 22.04','Móvil','2025-12-11 14:27:03','2025-04-02 13:09:32',1,'000USU'),('009DEV','203.147.9.166','e7b68a2930c4a212951b80292bb23cbc07be676cd08e9d9d1b1031a5cefbc55b','Samsung Internet 23.0','iPadOS 17','Computador','2025-12-11 14:27:03','2025-08-19 22:47:11',1,'000USU'),('010DEV','98.188.89.98','e7b68a2930c4a212951b80292bb23cbc07be676cd08e9d9d1b1031a5cefbc55b','Chromium 120.0','ChromeOS 120','Tablet','2025-12-11 14:27:03','2025-11-03 09:14:55',1,'000USU'),('011DEV','192.168.2.12','18ba619ef533b663b754f54eef4e1f02dc6390673ab90d86fa9e6f243709c8b3','Chrome Mobile 143.0.0','Android 10','Móvil','2025-12-13 14:58:39','2025-12-13 14:58:39',1,'000USU');
...
INSERT INTO `tbl_localidad` VALUES ('000LOC','No','000CIU'),('001LOC','Rafael Uribe Uribe','001CIU'),('002LOC','Bogota','001CIU'),('003LOC','Prueba','003CIU');
...
-- Dump completed on 2026-01-06 16:34:03
