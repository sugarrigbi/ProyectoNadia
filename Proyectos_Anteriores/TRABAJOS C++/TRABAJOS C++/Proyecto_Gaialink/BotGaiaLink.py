...
def webhook():
    ...
    if incoming_msg == "hola":
        ...
        msg.body("Para usar el aplicativo libremente debes registrarte primero como usuario en la opción crear usuario, a partir de ahí podrás ingresar y crear casos con información del incidente ocurrido.")
    elif incoming_msg == "Cómo funciona el aplicativo?":
        msg.body("Para usar el aplicativo libremente debes registrarte primero como usuario en la opción crear usuario, a partir de ahí podrás ingresar y crear casos con información del incidente ocurrido.")
    elif incoming_msg == "2":
        msg.body("El aplicativo tiene como objetivo notificar casos de restitucion de biebes (Desplazamiento, hurto, expropiación y predios despojados) a las autoridades competentes en la región de la mesa, agilizando la respuesta y mitigación de emergencias.")
        ...
        msg.body("En Gaialink somos un equipo dedicado al desarrollo de soluciones tecnológicas para la gestión de restitucion de bienes, enfocados en proteger a las comunidades de la mesa mediante herramientas eficientes y accesibles.")
    elif incoming_msg == "6":
        msg.body("En Gaialink somos un equipo dedicado al desarrollo de soluciones tecnológicas para la gestión de restitucion de bienes, enfocados en proteger a las comunidades de la mesa mediante herramientas eficientes y accesibles.")
    elif incoming_msg == "7":
        msg.body("Da click en el siguiente enlace: https://app.onedesk.com/app-od/es/o-yourorganization1747408434883/web-page?customerAccess=")
    elif incoming_msg == "Mesa de ayuda":
        msg.body("Da click en el siguiente enlace: https://app.onedesk.com/app-od/es/o-yourorganization1747408434883/web-page?customerAccess=")
    elif incoming_msg == "8":
        msg.body("Si deseas contactarnos directamente puedes hacerlo por los siguientes medios: Correo: gaialink.contacto@gmail.com.  Telefono: 314 4048151")
